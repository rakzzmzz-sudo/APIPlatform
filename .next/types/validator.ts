...
// Validate ../../src/app/api/db/[table]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/db/[table]">> = Specific
  const handler = {} as typeof import("../../src/app/api/db/[table]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/pages/api/voice-agents/seed.ts
{
  ...
  const handler = {} as typeof import("../../src/pages/api/voice-agents/seed.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
