...
function BulkWeChat() {
    ...
    const [wechatAccount, setWechatAccount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [wechatAccounts, setWechatAccounts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
        ...
        "BulkWeChat.useEffect": ()=>{
            if (user) {
                Promise.all([
                    ...
                    "BulkWeChat.useEffect": ()=>setLoading(false)
                }["BulkWeChat.useEffect"]);
            }
        }
    }["BulkWeChat.useEffect"], [
        ...
        "BulkWeChat.useEffect": ()=>{
            if (notification) {
                const timer = setTimeout({
                    "BulkWeChat.useEffect.timer": ()=>setNotification(null)
                }["BulkWeChat.useEffect.timer"], 5000);
                return ({
                    "BulkWeChat.useEffect": ()=>clearTimeout(timer)
                })["BulkWeChat.useEffect"];
            }
        }
    }["BulkWeChat.useEffect"], [
    ...
    const loadCampaigns = async ()=>{
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('wechat_campaigns').select('*').order('created_at', {
            ascending: false
        });
        if (statusFilter !== 'all') {
    ...
    const loadCampaignMessages = async (campaignId)=>{
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('wechat_messages').select('*').eq('campaign_id', campaignId).order('created_at', {
            ascending: false
        }).limit(100);
        if (!error && data) {
    ...
    const loadTemplates = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('wechat_templates').select('*').order('name');
        if (!error && data) {
            setTemplates(data);
        }
    };
    const loadStats = async ()=>{
        const { data: campaignsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('wechat_campaigns').select('total_recipients, valid_numbers, status');
        if (campaignsData) {
    ...
    const loadWeChatAccounts = async ()=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('wechat_accounts').select('*').eq('is_active', true);
    ...
    const handleSendCampaign = async ()=>{
        ...
        try {
            const { data: campaign, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('wechat_campaigns').insert({
                user_id: user.id,
            ...
            const { error: messagesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('wechat_messages').insert(messages);
    ...
    const updateCampaignStatus = async (campaignId, newStatus)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('wechat_campaigns').update({
                status: newStatus
            }).eq('id', campaignId);
            if (error) throw error;
            setNotification({
    ...
    const deleteCampaign = async (campaignId)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('wechat_campaigns').delete().eq('id', campaignId);
            if (error) throw error;
            setNotification({
                type: 'success',
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        ...
                                                        className: "w-full bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3 text-white",
                                                        children: wechatAccounts.map((account)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                value: account.id,
...
_s(BulkWeChat, "TDyY7ioIuA3DeC7lJhyg+5J6Ci4=", false, function() {
    return [
...
//# sourceMappingURL=src_components_Channels_BulkWeChat_tsx_a6acaf80._.js.map