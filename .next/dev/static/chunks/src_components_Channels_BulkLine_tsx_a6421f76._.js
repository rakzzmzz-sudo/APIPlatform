...
function BulkLine() {
    ...
    const [lineAccount, setLineAccount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [lineAccounts, setLineAccounts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
        ...
        "BulkLine.useEffect": ()=>{
            if (user) {
                Promise.all([
                    ...
                    "BulkLine.useEffect": ()=>setLoading(false)
                }["BulkLine.useEffect"]);
            }
        }
    }["BulkLine.useEffect"], [
        ...
        "BulkLine.useEffect": ()=>{
            if (notification) {
                const timer = setTimeout({
                    "BulkLine.useEffect.timer": ()=>setNotification(null)
                }["BulkLine.useEffect.timer"], 5000);
                return ({
                    "BulkLine.useEffect": ()=>clearTimeout(timer)
                })["BulkLine.useEffect"];
            }
        }
    }["BulkLine.useEffect"], [
    ...
    const loadCampaigns = async ()=>{
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('line_campaigns').select('*').order('created_at', {
            ascending: false
        });
        if (statusFilter !== 'all') {
    ...
    const loadCampaignMessages = async (campaignId)=>{
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('line_messages').select('*').eq('campaign_id', campaignId).order('created_at', {
            ascending: false
        }).limit(100);
        if (!error && data) {
    ...
    const loadTemplates = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('line_templates').select('*').order('name');
        if (!error && data) {
            setTemplates(data);
        }
    };
    const loadStats = async ()=>{
        const { data: campaignsData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('line_campaigns').select('total_recipients, valid_numbers, status');
        if (campaignsData) {
    ...
    const loadLineAccounts = async ()=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('line_accounts').select('*').eq('is_active', true);
    ...
    const handleSendCampaign = async ()=>{
        ...
        try {
            const { data: campaign, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('line_campaigns').insert({
                user_id: user.id,
            ...
            const { error: messagesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('line_messages').insert(messages);
    ...
    const updateCampaignStatus = async (campaignId, newStatus)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('line_campaigns').update({
                status: newStatus
            }).eq('id', campaignId);
            if (error) throw error;
            setNotification({
    ...
    const deleteCampaign = async (campaignId)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].from('line_campaigns').delete().eq('id', campaignId);
            if (error) throw error;
            setNotification({
                type: 'success',
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        ...
                                                        className: "w-full bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3 text-white",
                                                        children: lineAccounts.map((account)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                value: account.id,
...
_s(BulkLine, "qZDQNwXyzTl/oFAWtSKtPH2ZslQ=", false, function() {
    return [
...
//# sourceMappingURL=src_components_Channels_BulkLine_tsx_a6421f76._.js.map