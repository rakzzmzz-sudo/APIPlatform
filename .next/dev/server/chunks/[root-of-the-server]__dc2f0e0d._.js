...
async function POST(request, { params } // Params is a promise in newer Next.js versions
    ...
    try {
            ...
            if (validFallbackTables.includes(table)) {
                ...
                try {
                    ...
                    if (operation === 'insert') {
                        ...
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$executeRawUnsafe(query, ...flatParams);
                        ...
                        result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$queryRawUnsafe(query, ...params);
                    }
        ...
        if (operation === 'select') {
            ...
            try {
                result = Array.isArray(data) ? await model.createMany({
                    data: data
                }) : await model.create({
                    data: data
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc2f0e0d._.js.map